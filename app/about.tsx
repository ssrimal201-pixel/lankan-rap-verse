...
export default function AboutScreen() {
  ...
  const userEmail = 'ssrimal201@gmail.com';

  const handleEmailPress = () => {
    Linking.openURL(`mailto:${userEmail}?subject=Lankan Rap Verse App Support`);
  };
...
const styles = StyleSheet.create({
  ...
  footerText: { color: '#444', textAlign: 'center', marginTop: 30, fontSize: 12, fontWeight: 'bold' }
});
